        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="col-sm-12 wow fadeInLeft delay-05s">
                    ...
                    <div>
                        <img src="<?php echo $server_url;?>/assets/img/about-us/guru-speak.jpg" class="img img-responsive img-center" style="max-width:600px;">
                    </div>

                    <div class="col-md-12 cta-info text-center quote-in-page">
                        <h3><em>"Creation emerged from stillness. The ultimate purpose of Yoga is to gather that stillness inside because stillness is the ultimate strength; in fact, it holds the complete Creation in it."</em></h3>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="col-md-12 cta-info text-center quote-in-page">
                            <h3><em>"Yog is a sadhna, not a business. It cannot be bought but is given by the Guru to the shishya. The purpose of yog is to free you from the clutches of maya, any attempts to tie the subject to commerce (or maya) will cause it to lose its efficacy."</em></h3>
                        </div>
                        ...
                        <div class="col-md-12 cta-info text-center quote-in-page">
                            <h3><em>"Yog is a Subject of Experience."</em></h3>
                        </div>
                        ...
                        <div class="col-md-12 cta-info text-center quote-in-page">
                            <h3><em>"Only that being can tread the path of sadhna who is willing to help others."</em></h3>
                        </div>
            ...
            <div class="col-sm-4 text-center">
                <h3><strong>Learn with Yogi Ashwini</strong></h3>
                <br>
                <p><strong>Vedic Martial Arts</strong></p>
                <iframe src="https://www.youtube.com/embed/ORRI6_MZ4dQ" frameborder="0" allowfullscreen></iframe>
                <br>
                <br>
                <p><strong>Yogi Ashwini's two-inch push</strong></p>
                <iframe src="https://www.youtube.com/embed/jxUvBsUYU9o" frameborder="0" allowfullscreen></iframe>
                ...
                <a href="#"><img src="<?php echo $server_url;?>/assets/img/about-us/sanatan-kriya.jpg" class="img img-responsive img-center" style="max-width:310px;"></a>
