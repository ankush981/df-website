        ...
        <div class="row">
            <div class="col-sm-12 wow fadeInLeft delay-05s">
                <div class="section-title">
                    ...
                    <div class="cta-info text-center quote-in-page"><h3><em>An authentic and awesome thesis on anti-ageing and its complexities made easy. A must-read for all ages." </em>&ndash; Lt. Gen. K. K. Singh, Neurophysician and Head, Army Research and Referral Hospital</h3></div>

                    <div class="cta-info text-center quote-in-page"><h3><em>"It's a thesis on anti-ageing, an effective tool for the same."</em> &ndash; Dr. Bhaskar Rao, Managing Director, CEO and Cardiothoracic Surgeon, KIMS Hospital (Krishna Institute of Medical Science)</h3></div>
